...
customer's own favorite product category, instead of a latent-factor
collaborative-filtering match.

This exists because ALS matrix factorization was benchmarked against it (see
...
the ALS factors were too sparsely supported to find.
"""
import pandas as pd
